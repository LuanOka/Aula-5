        ...
        <form action="inserir_filme" method="post">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-8">
                	<form:errors path="local.titulo" cssStyle="color:red"/><br>
            ...
            <div class="row">
                <div class="form-group col-md-12">
                	<form:errors path="local.descricao" cssStyle="color:red"/><br>
            ...
            <div class="row">
                <div class="form-group col-md-8">
                	<form:errors path="local.direcao" cssStyle="color:red"/><br>
            ...
            <div id="actions" class="row">
                <div class="col-md-12">
                    ...
                    <a href="/pipoca/listarFilmes" class="btn btn-default">Cancelar</a>
                </div>
            </div>
        </form>
    </div>
